...
void loop() {     
  ...
  /*Serial.print(desireForwardAngPos); Serial.print("\t"); Serial.print(R_angPosNow); Serial.print("\t"); Serial.print(L_angPosNow);
  Serial.print("\n");
  Serial.print("Desired phi: "); Serial.print(phi_des);
  //Serial.print("\t"); Serial.print("Desired phi: "); Serial.print(phi_now);
  //Serial.print("\t"); Serial.print("Actual phi: "); Serial.print(phi_now);
  Serial.print("\t"); Serial.print("L_angPosNow: "); Serial.print(L_angPosNow);
  Serial.print("\t"); Serial.print("L_angPosPrev: "); Serial.print(L_angPosPrev);
  Serial.print("\t"); Serial.print("L_linVel: "); Serial.print(L_linVel);
  //Serial.print("\t"); Serial.print("R_linVel: "); Serial.print(R_linVel);
  Serial.print("\t"); Serial.print("RotVel: "); Serial.print(J_rotVel);
  Serial.print("\n");*/
