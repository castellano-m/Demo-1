...
* **MarkerDetec+AngleCalc.py**: Detects any aruco markers that appear within field of view of the camera. Calculated the distance and angle of center of the aruco marker from the center of the camera. 

* **LCD**: Prints the angle and distance values calculated from **MarkerDetect+AngleCalc.py** to the LCD screen
