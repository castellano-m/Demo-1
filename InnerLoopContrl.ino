...
double        scaleL_PWM = .94;                                                 

double        J_linVel = 0.0;                                                 // [in/s]  linear velocity of robot as whole              
double        J_rotVel = 0.0;                                                 // [rad/s] rotational velocity of robot as whole
...
double fkProp       = 0.044594;
double fkInteg      = 1.13395;
